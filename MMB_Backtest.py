...
#for i in list(range(0,2)):
    ...
    for i in list(range(0, 64)):            ### L2 Alpha Array 수 Case 64
        ...
        Profit_Standard_str = "profit_Standard " + str(Total_Asset)
    ...
    for i in list(range(0, 1)):             ## 유전적 알고리즘을 위한 정리
        ...
        ## X2 +Mutant
        Alpha_Array[48] = np.random.randint(0,2**Value_bit)
        Alpha_Array[49] = np.random.randint(0,2**Value_bit)
        Alpha_Array[50] = np.random.randint(0,2**Value_bit)
        Alpha_Array[51] = np.random.randint(0,2**Value_bit)
        Alpha_Array[52] = np.random.randint(0,2**Value_bit)
        Alpha_Array[53] = np.random.randint(0,2**Value_bit)
        Alpha_Array[54] = np.random.randint(0,2**Value_bit)
        Alpha_Array[55] = np.random.randint(0,2**Value_bit)
        ## X2 -Mutant
